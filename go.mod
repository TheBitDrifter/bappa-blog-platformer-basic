...
require github.com/TheBitDrifter/coldbrew v0.0.3-early-alpha

require (
	github.com/TheBitDrifter/bark v0.0.0-20250302175939-26104a815ed9 // indirect
	github.com/TheBitDrifter/blueprint v0.0.2-early-alpha.1 // indirect
	...
	github.com/TheBitDrifter/warehouse v0.0.1-early-alpha.1 // indirect
